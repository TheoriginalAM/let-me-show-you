    ...
    <main className="mx-auto flex min-h-screen max-w-3xl flex-col justify-center gap-10 px-6 py-16">
      <header className="flex flex-col gap-4">
        ...
        <p className="max-w-xl text-lg text-neutral-600 dark:text-neutral-400">
          Record your screen on the desktop app, then share it anywhere with a single link.
        </p>
        <nav className="flex gap-3">
          ...
          <Link
            href="/dashboard"
            className="rounded-lg px-4 py-2 text-sm font-medium text-indigo-600 hover:underline dark:text-indigo-400"
          >
            Dashboard
          </Link>
        </nav>
      ...
      <section className="rounded-2xl border border-neutral-200 p-6 dark:border-neutral-800">
        ...
        <dl className="grid grid-cols-2 gap-4 text-sm sm:grid-cols-3">
          ...
          <div>
            ...
            <dd className="font-medium">{formatDuration(sampleVideo.durationSeconds)}</dd>
          </div>
          <div>
